...
public class Soldado {
    ...
    public Soldado(String nom, int nivAtaq, int nivDef, int nivVida, int nivAct, int vel, 
    		String act, boolean vivir, int pFila, char pCol, char fig){
        nombre = nom;
        nivelAtaque = nivAtaq;
        nivelDefensa = nivDef;
        nivelVida = nivVida;
    ...
    public String toString(){
        return "Nombre: " + nombre + " Vida:" + vidaActual + " Fila:" + posFila + 
        		" Columna:" + posCol + " Actitud:" + actitud;
    }
    //gets
