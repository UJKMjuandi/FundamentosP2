...
public class VideoJuego {
    ...
    public static void juegoRapido() {  
        ...
        while (juegoActivo) {
            ...
            System.out.println("Cantidad de soldados en el Ejército 2: " + Soldado.getSEjer2());
            System.out.println("Cantidad de soldados en total: " + Soldado.getSoldCread());
    ...
    public static void llenarSoldados1(ArrayList<Soldado> soldados, int n) {
    	int cantidadSoldadosRestantes = Soldado.Soldados - soldados.size();
    ...
    public static void imprimirSoldados(ArrayList<Soldado> ejercito) {
    	if (ejercito == ejercito1) {
            System.out.println("Cantidad de soldados en el Ejército 1: " + Soldado.getSEjer1());
    ...
    public static void iCaracteristicas(Soldado soldado) {
    ...
    public static void buscarSoldadoPorNombre(Scanner sc, ArrayList<Soldado> ejercito) {
        ...
        if (soldadoEncontrado != null) {
            iCaracteristicas(soldadoEncontrado);
        } else {
            System.out.println("Soldado no encontrado en el ejército.");
        }
    }
